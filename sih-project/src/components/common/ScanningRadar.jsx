...
export default function ScanningRadar({ text = "AI Engine Analyzing Packaged Commodity Label..." }) {
  return (
    <div className="relative flex flex-col items-center justify-center p-8 bg-[#F5E6D8]/90 rounded-2xl border border-[#C1502D]/30 overflow-hidden shadow-2xl backdrop-blur-md">
      <div className="relative w-40 h-40 flex items-center justify-center">
        <div
          className="absolute inset-0 rounded-full border border-[#C1502D]/20 animate-ping"
      ...
      <p className="mt-6 text-sm font-medium text-[#FFF9F2] tracking-wide animate-pulse text-center">
        {text}
      </p>
      <div className="mt-3 flex items-center gap-2 text-xs text-[#7A5C48]">
        <span className="inline-block w-2 h-2 rounded-full bg-[#7A8450] animate-ping"></span>
